...
namespace GagongSyndra
{
    class Program
    {
        ...
        static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //Orbwalker = new Orbwalking.Orbwalker(orbwalkerMenu);            //comment this out
            GagongSyndra.xSLxOrbwalker.AddToMenu(orbwalkerMenu); 
        ...
        {   
           ...
           //Use QW if no grabbable objects nearby QWE Mana supported and enemy > 150 range
            if (UW && UQ && W.IsReady() && Player.Spellbook.GetSpell(SpellSlot.Q).ManaCost + Player.Spellbook.GetSpell(SpellSlot.W).ManaCost + Player.Spellbook.GetSpell(SpellSlot.E).ManaCost <= Player.Mana && QTarget != null && Environment.TickCount - QWLastcast > Game.Ping +150)
            {
